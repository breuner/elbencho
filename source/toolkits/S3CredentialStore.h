/**
 * @file S3CredentialStore.h
 *
 * Singleton class to manage multiple S3 credentials for different workers.
 * This class provides functionality to load and manage multiple S3 credentials,
 * which can be assigned to different workers in a round-robin fashion.
 */
