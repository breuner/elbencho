...
cmd+="-F -d -n 1 -N 18725 "
cmd+="-s 1m --trunctosize "
cmd+="-b 16m --direct --dropcache --nodelerr ./1048576x1MiB"
$cmd

echo "B. Run the command directly ..."
echo "The command to execute..."
echo "elbencho  --dirsharing -w -t 56 --nolive -F -d -n 1 -N 18725 -s 1m --trunctosize -b 16m --direct --dropcache --nodelerr  ./1048576x1MiB"
